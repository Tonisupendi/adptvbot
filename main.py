...
# === Ambil token dari Environment Variable (Railway Dashboard) ===
TOKEN = os.getenv("TOKEN")  # KEY harus TOKEN di Railway
if not TOKEN:
    raise ValueError("⚠️ TOKEN belum di-set di Environment Variables Railway!")
